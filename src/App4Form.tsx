...
class Form extends Component<{}, FormState> {
    ...
    handleTextAreaChange = (e: React.ChangeEvent<HTMLTextAreaElement>): void => {
        ...
        this.setState({textareaText: textAreaText});
    }
    handleSelectTextChange = (e: React.ChangeEvent<HTMLSelectElement>): void => {
            ...
            <>
                <form>
                    ...
                    <select
                        style={styles}
                        value={selectText}
                        onChange={this.handleSelectTextChange}
                        ref={this.rootRef}
                    >
